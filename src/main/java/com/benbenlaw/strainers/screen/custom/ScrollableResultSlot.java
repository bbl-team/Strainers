...
public class ScrollableResultSlot extends Slot {
    ...
    private final StrainerMenu menu;
    private final int visibleIndex;

    public ScrollableResultSlot(StrainerMenu menu, int visibleIndex, int x, int y) {
    ...
    private int realIndex() {
        return 2 + visibleIndex + (menu.getScrollOffset() * StrainerMenu.COLUMNS);
    }
