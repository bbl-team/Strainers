...
public class StrainersTags {
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> tag(String name) {
            return BlockTags.create(Identifier.fromNamespaceAndPath(Strainers.MOD_ID, name));
        }
    ...
    public static class Items {
        ...
        private static TagKey<Item> tag(String name) {
            return ItemTags.create(Identifier.fromNamespaceAndPath(Strainers.MOD_ID, name));
        }
