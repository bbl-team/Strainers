...
public class StrainersItemTags extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        tag(com.benbenlaw.strainers.util.ModTags.Items.TIER_7_MESHES)
                .add(ModItems.DIAMOND_MESH.get())
                .add(ModItems.EMERALD_MESH.get())
                .add(ModItems.AMETHYST_MESH.get())
        ;

        tag(com.benbenlaw.strainers.util.ModTags.Items.TIER_8_MESHES)
                .add(ModItems.NETHERITE_MESH.get())
                .add(ModItems.OBSIDIAN_MESH.get())
        ;

        tag(com.benbenlaw.strainers.util.ModTags.Items.TIER_9_MESHES)
                .add(ModItems.HEAVY_MESH.get())
        ;

        tag(com.benbenlaw.strainers.util.ModTags.Items.TIER_10_MESHES)
        ...
        tag(com.benbenlaw.strainers.util.ModTags.Items.MESHES)
                ...
                .addTag(com.benbenlaw.strainers.util.ModTags.Items.TIER_7_MESHES)
                .addTag(com.benbenlaw.strainers.util.ModTags.Items.TIER_8_MESHES)
                .addTag(com.benbenlaw.strainers.util.ModTags.Items.TIER_9_MESHES)
                .addTag(com.benbenlaw.strainers.util.ModTags.Items.TIER_10_MESHES)
        ;
